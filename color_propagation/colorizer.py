...
from color_propagation.colorizationSolver import colorize
...
def propagate():
  ...
  # read images
  greyImage = mpimg.imread('C:\\Users\\shrut\\OneDrive\\Desktop\\final_code\\input.png', format='png')
  ...
  # save output
  mpimg.imsave('C:\\Users\\shrut\\OneDrive\\Desktop\\final_code\\output.png',colouredImage, format='png')
